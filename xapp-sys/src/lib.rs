...
impl ::std::fmt::Debug for XAppFavoriteInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppFavoriteInfo @ {self:p}"))
         .field("uri", &self.uri)
...
impl ::std::fmt::Debug for XAppFavoritesClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppFavoritesClass @ {self:p}"))
...
impl ::std::fmt::Debug for XAppGtkWindowClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppGtkWindowClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
...
impl ::std::fmt::Debug for XAppIconChooserButtonClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppIconChooserButtonClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppIconChooserDialogClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppIconChooserDialogClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppKbdLayoutControllerClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppKbdLayoutControllerClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppMonitorBlankerClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppMonitorBlankerClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppObjectIface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppObjectIface @ {self:p}"))
...
impl ::std::fmt::Debug for XAppObjectManagerClientClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppObjectManagerClientClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppObjectProxyClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppObjectProxyClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppObjectSkeletonClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppObjectSkeletonClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppPreferencesWindowClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppPreferencesWindowClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
...
impl ::std::fmt::Debug for XAppStackSidebarClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStackSidebarClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppStatusIconClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStatusIconClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppStatusIconInterfaceIface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStatusIconInterfaceIface @ {self:p}"))
         .field("parent_iface", &self.parent_iface)
...
impl ::std::fmt::Debug for XAppStatusIconInterfaceProxyClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStatusIconInterfaceProxyClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppStatusIconInterfaceSkeletonClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStatusIconInterfaceSkeletonClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppStatusIconMonitorClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStatusIconMonitorClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppStyleManagerClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStyleManagerClass @ {self:p}"))
         .field("parent_class", &self.parent_class)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppFavorites {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppFavorites @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppGtkWindow {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppGtkWindow @ {self:p}"))
...
impl ::std::fmt::Debug for XAppIconChooserButton {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppIconChooserButton @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppIconChooserDialog {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppIconChooserDialog @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppKbdLayoutController {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppKbdLayoutController @ {self:p}"))
...
impl ::std::fmt::Debug for XAppMonitorBlanker {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppMonitorBlanker @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppObjectManagerClient {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppObjectManagerClient @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppObjectProxy {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppObjectProxy @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppObjectSkeleton {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppObjectSkeleton @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppPreferencesWindow {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppPreferencesWindow @ {self:p}"))
         .field("parent_instance", &self.parent_instance)
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppStackSidebar {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStackSidebar @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppStatusIcon {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStatusIcon @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppStatusIconInterfaceProxy {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStatusIconInterfaceProxy @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppStatusIconInterfaceSkeleton {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStatusIconInterfaceSkeleton @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppStatusIconMonitor {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStatusIconMonitor @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppStyleManager {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("XAppStyleManager @ {self:p}"))
         .finish()
    }
}
...
impl ::std::fmt::Debug for XAppStatusIconInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "XAppStatusIconInterface @ {self:p}")
    }
}
